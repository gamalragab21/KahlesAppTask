package net.gamal.kahlesapptask.core.common.data.repository.remote

import net.gamal.kahlesapptask.android.extentions.getModelFromJSON
import net.gamal.kahlesapptask.core.common.domain.repository.remote.INetworkProvider
import okhttp3.ResponseBody.Companion.toResponseBody
import retrofit2.HttpException
import java.lang.reflect.Type

internal class RetrofitNetworkProvider(private val apiService: PostsApiService) :
    INetworkProvider {
